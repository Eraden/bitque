  ...
  patterns: vec![
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3712 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
    ...
    Pattern::Match(MatchPattern {
      ...
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3723 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3716 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3726 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
