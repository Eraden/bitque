...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Include(ContextReference::Direct(ContextId { index: 9645 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9641 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9585 })),
