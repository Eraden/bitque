...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Include(ContextReference::Direct(ContextId { index: 7800 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 7798 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 7799 })),
