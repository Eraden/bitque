  ...
  patterns: vec![
    ...
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3746 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3617 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
    ...
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Push(vec![
        ContextReference::Direct(ContextId { index: 3618 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 3619 }),
    ]),
      with_prototype: None
    }),
