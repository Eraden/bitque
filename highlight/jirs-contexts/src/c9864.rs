...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Include(ContextReference::Direct(ContextId { index: 9942 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9857 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9883 })),
