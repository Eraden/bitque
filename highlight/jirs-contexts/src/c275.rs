...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Push(vec![
        ContextReference::Direct(ContextId { index: 276 }),
    ]),
      with_prototype: None
    }),
    Pattern::Include(ContextReference::Direct(ContextId { index: 376 })),
]
} }