...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Include(ContextReference::Direct(ContextId { index: 8329 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 8283 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 8320 })),
