  ...
  patterns: vec![
    ...
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 1100 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 1234 }),
    ...
    Pattern::Match(MatchPattern {
      has_captures: false,
      regex: Regex::new("(?=\\*\\s*[\\p{L}_][\\p{L}0-9_]*\\s*[=;\\(])"),
      scope: vec![],
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 1256 }),
    ...
    Pattern::Match(MatchPattern {
      ...
      captures: None,
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 1358 }),
