...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Include(ContextReference::Direct(ContextId { index: 9951 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9947 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9880 })),
