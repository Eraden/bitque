...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Include(ContextReference::Direct(ContextId { index: 9158 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9105 })),
    Pattern::Include(ContextReference::Direct(ContextId { index: 9137 })),
