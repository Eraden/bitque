...
pub fn load() -> Context {
  ...
  patterns: vec![
    ...
    Pattern::Match(MatchPattern {
      has_captures: false,
      regex: Regex::new("\\boperator\\s*(?:[-+*/%^&|~!=<>]|[-+*/%^&|=!<>]=|<<=?|>>=?|&&|\\|\\||\\+\\+|--|,|->\\*?|\\(\\)|\\[\\]|\"\"\\s*\\b[\\p{L}_][\\p{L}\\p{N}_]*\\b)(?=\\s*(\\(|(?m:$)))"),
      scope: vec![
        Scope {
            a: 46444084122615808,
            b: 0,
    ...
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Push(vec![
        ContextReference::Direct(ContextId { index: 444 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 617 }),
        ContextReference::Direct(ContextId { index: 570 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
      ...
      operation: MatchOperation::Set(vec![
        ContextReference::Direct(ContextId { index: 617 }),
        ContextReference::Direct(ContextId { index: 569 }),
    ]),
      with_prototype: None
    }),
    Pattern::Match(MatchPattern {
